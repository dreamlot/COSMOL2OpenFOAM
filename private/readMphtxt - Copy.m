...
%       parameters, matrix:
% 
%       n_domain, integer:      number of domains
%       domains, vector:        master geometric entity indix IDs 
%                               of each element
% 
% Ningyu Wang, March 2017
function [V, elem_data] = readMphtxt( file_name )
%% Open file
